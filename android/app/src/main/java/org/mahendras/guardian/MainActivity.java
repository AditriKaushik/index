...
public class MainActivity extends Activity {
    ...
    private static final String APP_URL = "https://" + APP_HOST + "/guardian/index.html";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        configureWebView();
        webView.addJavascriptInterface(new GuardianHost(), "GuardianHost");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (ACTION_STOP_SHARING.equals(intent.getAction())) {
            ...
            webView.evaluateJavascript("window.__guardianStop && window.__guardianStop();", null);
            return;
        }
